...
class UncompletedListview extends StatelessWidget {
  const UncompletedListview({super.key});
    ...
    return BlocBuilder<TodosCubit, TodosState>(
      builder: (context, state) {
        if (state is TodosLoading) {
          ...
          final uncompletedTasks = todos.where((todo) => !todo.done).toList();
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => TodoDetailsView(
                                todoModel: uncompletedTasks[index],
                              ),
                            ),
                          );
                        },
